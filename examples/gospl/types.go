// Package gospl contains the deterministic client ABI for the custom GOSPL
...
// InstructionKind is the stable one-byte GOSPL instruction discriminant.
...
func (e ProgramError) Error() string {
	return fmt.Sprintf("gospl: custom program error %d", uint32(e))
}

var (
	ErrInvalidInstructionEncoding = errors.New("gospl: invalid instruction encoding")
	ErrInvalidStateEncoding       = errors.New("gospl: invalid state encoding")
)
